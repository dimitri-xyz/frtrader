...
Open orders are "active" orders. In other words, orders that have been placed, but are neither fully executed or yet cancelled. Open volume is volume in those orders than has not yet been filled.
